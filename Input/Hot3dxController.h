//********************************************************* 
// 
// Copyright (c) 2020 Jeff Kubitz. All rights reserved. 
...
//
// The touch portion of the Hot3dxController divides the window area of the app
...
//
// Because the Hot3dxController can be use in a variety of environments
...
// Hot3dxController is used in a XAML app, and is not necessary when it is
// used in a CoreWindow/DirectX app.
//
// The Hot3dxController collects input from each of the input events.
...
// #define HOT3DXCONTROLLER_TRACE 1

enum class Hot3dxControllerState
{
    None,
    WaitForInput,
    Active,
...
namespace Hot3dxControllerConstants
{
...
internal:
    ...
    Hot3dxController(_In_ Windows::UI::Core::CoreWindow^ window);
